...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
      ...
      <form action="https://getform.io/f/0c30fafb-2e6c-48e5-a0f8-f591534d1547" method="post" encType='multipart/form-data'>
        <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
          ...
          <div>
            <div>
              <input className='bg-[#001b5e] text-gray-100 mt-10 w-full p-4 rounded-lg' type="submit" value="Send Message" />
            </div>
          </div>
        </div>
      </form>
